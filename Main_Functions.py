...
def main_function_Group1_Part1(df_clean):
    try:   
        ...
        colors = ['#a4a7ed', '#ff7f7f', '#a6d854', '#118DFF']
...
def main_function_Group1_Part2(df_clean):
    try:
        ...
        explode = (0, 0, 0, 0)
        colors = ['#8c510a', '#d8b365', '#f6e8c3', '#BCB88A']
        sns.set_palette(sns.color_palette(colors))
        ax.pie(df_region['COVID-19 Deaths'], labels=df_region['Region'], 
        ...
        ax.bar(df_Age_Group_Sum["Age Group"], df_Age_Group_Sum["IPC_Sum"], color='#a4a7ed', edgecolor='black')
        ...
        # Plot the data using the plot function
        # Add color changed and frame
        ax.bar(df_Age_Group_Sum["Age Group"], df_Age_Group_Sum["COVID-19 Deaths"], color='#eda4d5', edgecolor='black')
        ...
        #y=0.1290+1.5288D_1+5.2814+D_2+14.9068+D_3+35.8427D_4+58.7592D_5+68.6160D_6+71.0842D7
